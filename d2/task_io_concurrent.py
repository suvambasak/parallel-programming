...
if __name__ == "__main__":
    ...
    save_content_threads: list[Thread] = []
    for idx, url in enumerate(urls):
        # save_content(idx, url)
        _t = Thread(target=save_content, args=(idx, url))
        save_content_threads.append(_t)

    for save_content_thread in save_content_threads:
        save_content_thread.start()

    for save_content_thread in save_content_threads:
        save_content_thread.join()
